export default {
  ...
  blocks: {
    _: 'Blocks',
    chain_density_24h: 'Chain density in last 24 hours',
  ...
  committee: {
    _: 'Committee',
    new_composition: 'New composition and terms of office',
  },
  completed: 'Completed',
  confirmed: 'Confirmed',
  constitutionality: {
