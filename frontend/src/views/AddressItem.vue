      ...
      <div class="relative order-1 flex flex-col">
        ...
        <div class="grid grid-cols-2 gap-2 text-sm font-medium">
          ...
          <div class="relative z-1 rounded-md bg-white p-1 pr-1.5 pl-5 text-right dark:bg-gray-800">
            ...
            <template v-if="stakeAccount">
              <RouterLink :to="{ name: 'account', params: { id: stakeAccount } }" class="ml-auto block max-w-40">
                <TextTruncate :text="stakeAccount" class="text-sky-500 *:underline dark:text-cyan-400" />
              </RouterLink>
              <TooltipAmount
